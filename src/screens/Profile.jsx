    ...
    <div style={styles.screen}>
      ...
      <div style={styles.content}>
        ...
        <div style={styles.menuCard}>
          ...
          <a href="https://instagram.com/stadoapp" target="_blank" rel="noopener noreferrer" style={styles.menuLink}>
          ...
          <a href="https://youtube.com/@stadoapp" target="_blank" rel="noopener noreferrer" style={styles.menuLink}>
          ...
          <div style={styles.menuDivider} />
          <a href="https://discord.gg/stado" target="_blank" rel="noopener noreferrer" style={styles.menuLink}>
          ...
          <div style={styles.menuDivider} />
          <a href="mailto:hello@stado.app" style={styles.menuLink}>
